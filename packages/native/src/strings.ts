 ...
 */
export type AureaUniversalState =
  | "waiting_user" | "waiting_approval" | "waiting_dependency"
  | "offline" | "stale" | "partial" | "degraded";

export const AUREA_UNIVERSAL_STATES: readonly AureaUniversalState[] = [
  "waiting_user", "waiting_approval", "waiting_dependency",
  "offline", "stale", "partial", "degraded",
];
 ...
 */
export const gravidadeDoEstado = (estado: AureaUniversalState): "info" | "warning" =>
  estado.startsWith("waiting_") ? "info" : "warning";
...
export const defaultStrings: AureaStrings = {
  loading: "Loading",
...
export const ptBR: AureaStrings = {
  loading: "Carregando",
