...
import { ReactFlow, ReactFlowProvider, Background, BaseEdge, Handle, Position, applyNodeChanges, getBezierPath } from "@xyflow/react";
...
const ROTULO = { fill: "var(--xy-edge-label-color)", fontSize: "var(--text-xs)" };
